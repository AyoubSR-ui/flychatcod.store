...
import { db, usersTable, organizationsTable, storesTable, subscriptionsTable, teamMembersTable, widgetConfigsTable, channelConnectionsTable } from "@workspace/db";
...
router.post("/reset-password", async (req, res) => {
  ...
  // Scaffold: In production, send a reset email
